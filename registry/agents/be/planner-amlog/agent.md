...
type: be
stage: planning
description: Breaks the spec into a back-end implementation plan using codegraph_explore. Use when the user wants to plan, design or start an API/.NET/database change that has no confirmed plan yet.
